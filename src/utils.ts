...
export function getArgs() {
  ...
  inputs = {...inputs, 'repo-branch': core.getInput('head-ref-name'),
  "workflow-dispatch-details": "Repo:"+ core.getInput('repo-name')+ " User:"+core.getInput('actor-name')+ " Ref:"+core.getInput('ref-name')+" From:"+core.getInput('head-ref-name')+" -> "+core.getInput('base-ref-name'), 
  "repo-name": core.getInput('repo-name'), 
  "ref-name": core.getInput('ref-name')
  }
  debug("inputs =>",inputs);
